...
const file_hello_service_proto_rawDesc = "" +
	"\n" +
	"\x13hello/service.proto\x12\bhello.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x16google/type/date.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"W\n" +
	"\x0fSayHelloRequest\x12\x1d\n" +
	"\x04name\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x02\x18\n" +
	"R\x04name\x12%\n" +
	"\x04date\x18\x02 \x01(\v2\x11.google.type.DateR\x04date\",\n" +
	"\x10SayHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2\xa7\x01\n" +
	"\fHelloService\x12\x96\x01\n" +
	"\bSayHello\x12\x19.hello.v1.SayHelloRequest\x1a\x1a.hello.v1.SayHelloResponse\"S\x92A<\x12\x14Say hello to someone\x1a$Use this API to say hello to someone\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/helloB\x92\x01\n" +
	"\fcom.hello.v1B\fServiceProtoP\x01Z3github.com/davidyannick86/bufbuild/testbuf/hello/v1\xa2\x02\x03HXX\xaa\x02\bHello.V1\xca\x02\bHello\\V1\xe2\x02\x14Hello\\V1\\GPBMetadata\xea\x02\tHello::V1b\x06proto3"
